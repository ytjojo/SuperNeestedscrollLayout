...
public class ViewOffsetHelper {
    ...
    public static ViewOffsetHelper getViewOffsetHelper(View view) {
        ViewOffsetHelper offsetHelper = (ViewOffsetHelper) view.getTag(com.ytjojo.viewlib.nestedscrolllayout.R.id.view_offset_helper);
        if (offsetHelper == null) {
            offsetHelper = new ViewOffsetHelper(view);
            view.setTag(com.ytjojo.viewlib.nestedscrolllayout.R.id.view_offset_helper, offsetHelper);
        }
        return offsetHelper;
    }
    public static void setViewOffsetHelper(View view,ViewOffsetHelper helper) {
        view.setTag(com.ytjojo.viewlib.nestedscrolllayout.R.id.view_offset_helper,helper);
    }
