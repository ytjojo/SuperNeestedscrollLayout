...
//        public static final int LAYOUT_FLAG_ANTHOR = 0x4;
        ...
        public LayoutParams(Context c, AttributeSet attrs) {
            super(c, attrs);
            final TypedArray a = c.obtainStyledAttributes(attrs, com.ytjojo.viewlib.nestedscrolllayout.R.styleable.NestedScrollLayout_LayoutParams);
            ...
            mDrawingOrderElevation = a.getDimensionPixelSize(R.styleable.NestedScrollLayout_LayoutParams_drawingOrderElevation,0);
            a.recycle();
        }
