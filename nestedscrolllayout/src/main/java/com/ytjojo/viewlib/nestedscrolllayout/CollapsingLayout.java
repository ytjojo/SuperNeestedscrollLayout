...
public class CollapsingLayout extends FrameLayout {
    ...
    public CollapsingLayout(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        TypedArray a = context.obtainStyledAttributes(attrs,
                R.styleable.Nested_CollapsingLayout, defStyleAttr,
                R.style.Widget_CollapsingLayout);

        mCollapsingTextHelper.setExpandedTextGravity(
                a.getInt(R.styleable.Nested_CollapsingLayout_expandedTitleLayoutGravity,
                        GravityCompat.START | Gravity.BOTTOM));
        mCollapsingTextHelper.setCollapsedTextGravity(
                a.getInt(R.styleable.Nested_CollapsingLayout_collapsedTitleLayoutGravity,
                        GravityCompat.START | Gravity.CENTER_VERTICAL));

        mExpandedMarginStart = mExpandedMarginTop = mExpandedMarginEnd = mExpandedMarginBottom =
                a.getDimensionPixelSize(R.styleable.Nested_CollapsingLayout_expandedTitleMargin, 0);

        if (a.hasValue(R.styleable.Nested_CollapsingLayout_expandedTitleMarginStart)) {
            mExpandedMarginStart = a.getDimensionPixelSize(
                    R.styleable.Nested_CollapsingLayout_expandedTitleMarginStart, 0);
        }
        if (a.hasValue(R.styleable.Nested_CollapsingLayout_expandedTitleMarginEnd)) {
            mExpandedMarginEnd = a.getDimensionPixelSize(
                    R.styleable.Nested_CollapsingLayout_expandedTitleMarginEnd, 0);
        }
        if (a.hasValue(R.styleable.Nested_CollapsingLayout_expandedTitleMarginTop)) {
            mExpandedMarginTop = a.getDimensionPixelSize(
                    R.styleable.Nested_CollapsingLayout_expandedTitleMarginTop, 0);
        }
        if (a.hasValue(R.styleable.Nested_CollapsingLayout_expandedTitleMarginBottom)) {
            mExpandedMarginBottom = a.getDimensionPixelSize(
                    R.styleable.Nested_CollapsingLayout_expandedTitleMarginBottom, 0);
        }

        mCollapsingTitleEnabled = a.getBoolean(
                R.styleable.Nested_CollapsingLayout_titleEnabled, true);
        setTitle(a.getText(R.styleable.Nested_CollapsingLayout_title));
        ...
        if (a.hasValue(R.styleable.Nested_CollapsingLayout_expandedTitleTextAppearance)) {
            mCollapsingTextHelper.setExpandedTextAppearance(
                    a.getResourceId(
                            R.styleable.Nested_CollapsingLayout_expandedTitleTextAppearance, 0));
        }
        if (a.hasValue(R.styleable.Nested_CollapsingLayout_collapsedTitleTextAppearance)) {
            mCollapsingTextHelper.setCollapsedTextAppearance(
                    a.getResourceId(
                            R.styleable.Nested_CollapsingLayout_collapsedTitleTextAppearance, 0));
        }

        mScrimVisibleHeightTrigger = a.getDimensionPixelSize(
                R.styleable.Nested_CollapsingLayout_scrimVisibleHeightTrigger, -1);

        mScrimAnimationDuration = a.getInt(
                R.styleable.Nested_CollapsingLayout_scrimAnimationDuration,
                DEFAULT_SCRIM_ANIMATION_DURATION);

        setContentScrim(a.getDrawable(R.styleable.Nested_CollapsingLayout_contentScrim));
        setStatusBarScrim(a.getDrawable(R.styleable.Nested_CollapsingLayout_statusBarScrim));

        mToolbarId = a.getResourceId(R.styleable.Nested_CollapsingLayout_toolbarId, -1);
    ...
    protected void onAttachedToWindow() {
        ...
        if (lp instanceof  NestedScrollLayout.LayoutParams) {
    ...
    public static class LayoutParams extends FrameLayout.LayoutParams {
        ...
        public LayoutParams(Context c, AttributeSet attrs) {
            ...
            TypedArray a = c.obtainStyledAttributes(attrs,
                    R.styleable.Nested_CollapsingLayout_Layout);
            mCollapseMode = a.getInt(
                    R.styleable.Nested_CollapsingLayout_Layout_SuperNested_collapseMode,
                    COLLAPSE_MODE_OFF);
            setParallaxMultiplier(a.getFloat(
                    R.styleable.Nested_CollapsingLayout_Layout_layout_collapseParallaxMultiplier,
